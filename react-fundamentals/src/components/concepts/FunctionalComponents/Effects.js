        ...
        <div className='main'>
            <div className='mainDiv'>
                ...
                <ul>
                    ...
                    <li>Effects are used to trigger certain action based upon changes to a component</li>
                    <li>Effects can return cleanup fuctions, which can clean up timers using memory, listeners to outside API's and other functions which may use system resources</li>
                </ul>
                <SampleEffect />
                <br />
                <SampleEffect />
