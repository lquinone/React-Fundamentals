        ...
        <div className='main'>
            <div className='mainDiv'>
                ...
                <ul>
                    ...
                    <li>The styling is intentionally left blang in some spots. Just a sandbox.</li>
                    <li>At this phase, this siteis not yet responsive.</li>
                    ...
                    <li>We have tried to collect the very best resources for this app, and we have cited those.</li>
